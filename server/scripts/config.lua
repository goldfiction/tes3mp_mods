...
config.gameMode = "goldfiction"

-- Time to login, in seconds
config.loginTime = 180
...
config.gameSettings = {
    ...
    { name = "trainers training skills based on base skill", value = false },
...
config.menuHelperFiles = { "help", "defaultCrafting", "advancedExample", "MenuGroup" }
