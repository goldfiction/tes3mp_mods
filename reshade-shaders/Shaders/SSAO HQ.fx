...
#define N 32 // Samples: 48, 32, 16, 10, 6. More means precision and performance hit.
...
static const float multiplier = 1.4; // Overall strength. 1.0 is the correct physical value
