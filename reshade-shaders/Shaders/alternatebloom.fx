...
static const float bloom_mult_global = 0.35f; // The overall multiplier for bloom. Effects all areas.
...
static const float bloom_mult_inside = 0.8f; // Interior multiplier for bloom. Can combine with bloom_mult_uwater when both are true.
static const float bloom_mult_outside = 0.3f; // Exterior multiplier for bloom. Can combine with bloom_mult_uwater when both are true.

static const float bloom_cutoff = 1.0f; // Effects the strength and focus of highlights (higher produces softer, weaker highlights).
static const float bloom_power = 0.4f; // Effects the focus and hue of highlights (higher creates more narrow, single-color highlights).
